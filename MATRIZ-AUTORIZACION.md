...
Agujero A1: se daba porque un analista podia ver las transferencias de una sucursal distinta a la suya; por lo cual se valida la sucursal del usuario con la de la solicitud para que sean iguales, si son distintas daria fallo. Afectaria al banco porque personas estarian viendo transferencias de sucursales que no le corresponden.
